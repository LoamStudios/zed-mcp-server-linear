...
const PACKAGE_NAME: &str = "@odgrim/linear-mcp";
const SERVER_PATH: &str = "node_modules/@odgrim/linear-mcp/build/index.js";
...
impl zed::Extension for LinearModelContextExtension {
    ...
    fn context_server_command(
        ...
        Ok(Command {
            ...
            args: vec![env::current_dir()
                ...
                .to_string_lossy()
                .to_string()],
            env: vec![("LINEAR_ACCESS_TOKEN".into(), settings.linear_api_key)],
        })
    }
    ...
    fn context_server_configuration(
        ...
        let settings_schema =
            serde_json::to_string(&schemars::schema_for!(LinearContextServerSettings))
